...
public class TimelineKey implements Serializable {
    ...
    public TimelineKey() {}
    public TimelineKey(UUID userId, LocalDate day, Instant createdAt, UUID postId) { this.userId=userId; this.bucketDay=day; this.createdAt=createdAt; this.postId=postId; }
