...
@PrimaryKeyClass
public class AuthorPostKey implements Serializable {
    @PrimaryKeyColumn(name = "author_id", ordinal = 0, type = PARTITIONED) private UUID authorId;
    ...
    public AuthorPostKey() {}
    public AuthorPostKey(UUID authorId, LocalDate day, Instant createdAt, UUID postId) { this.authorId=authorId; this.bucketDay=day; this.createdAt=createdAt; this.postId=postId; }
